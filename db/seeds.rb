...
category = Category.create(name: "Expensive")

# [3, 5, 4]

ProductCategory.create(category_id: category.id, product_id: 3)
ProductCategory.create(category_id: category.id, product_id: 5)
ProductCategory.create(category_id: category.id, product_id: 4)
